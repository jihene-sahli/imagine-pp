...
public interface BusinessService {
	...
	List<BizSousFamille> getSubFamilyList();
	...
	List<BizSrFamille> getFamilyListForRayon(BizSecteur sec, BizRayon ray);

	List<BizSrfSousFamille> getSubFamilyListForFamily(BizSrFamille srFamille);
