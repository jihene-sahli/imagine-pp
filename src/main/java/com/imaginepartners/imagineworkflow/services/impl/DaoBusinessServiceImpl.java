...
import com.imaginepartners.imagineworkflow.models.rh.RhFicheDePoste;
...
public class DaoBusinessServiceImpl implements DaoBusinessService, Serializable {
	...
	@Override
	public BizSrFamille getSecteurFamilleRayonById(BizSecteurRayon secteurRayonId, BizFamille familleId) {
		return (BizSrFamille) getCurrentSession().createCriteria(BizSrFamille.class).add(Restrictions.eq("secteurRayon", secteurRayonId)).add(Restrictions.eq("famille", familleId)).uniqueResult();
	}
	...
	public List<BizSousFamille> getSubFamilyList() {
		return getCurrentSession().createCriteria(BizSousFamille.class).list();
	}
	...
	@Override
	public List<BizSrFamille> getFamilyListForRayon(BizSecteur secteur, BizRayon rayon) {
		BizSecteurRayon sr = (BizSecteurRayon) getCurrentSession().createCriteria(BizSecteurRayon.class)
		.add(Restrictions.eq("secteur", secteur))
		.add(Restrictions.eq("rayon", rayon))
		.uniqueResult();
		if (sr != null) {
			Hibernate.initialize(sr.getBizSrFamilleList());
			return sr.getBizSrFamilleList();
		}
		return null;
	}

	@Override
	public List<BizSrfSousFamille> getSubFamilyListForFamily(BizSrFamille srFamille) {
		return getCurrentSession().createCriteria(BizSrfSousFamille.class).add(Restrictions.eq("secteurRayonFamille", srFamille)).list();
	}
	...
	@Override
	public List<BizSrFamille> getSecteurRayonFamilleList(BizSecteurRayon secteurRayonId) {
		return getCurrentSession().createCriteria(BizSrFamille.class).add(Restrictions.eq("secteurRayon", secteurRayonId)).list();
	}

	@Override
	public List<BizSrfSousFamille> getSecteurRayonFamilleSousFamilleList(BizSrFamille secteurRayonFamileId) {
		return getCurrentSession().createCriteria(BizSrfSousFamille.class).add(Restrictions.eq("secteurRayonFamille", secteurRayonFamileId)).list();
	}
