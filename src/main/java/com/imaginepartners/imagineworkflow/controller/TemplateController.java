...
import java.util.List;
	...
	public class TemplateController  implements Serializable {
		...
		private List<IwFormTemplate> templateList;
		...
		public void init() {
			...
			if (businessService.getIwFormTemplateList().isEmpty()){
				templateList = new ArrayList<IwFormTemplate>();

			}else {
				templateList =businessService.getIwFormTemplateList();
		...
		public List<IwFormTemplate> getTemplateList() {
			return templateList;
		}

		public void setTemplateList(List<IwFormTemplate> templateList) {
